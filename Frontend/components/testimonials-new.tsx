      ...
      <div className="container-star">
                ...
                <div className="flex items-center space-x-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <div key={i} className="relative">
                      <Star 
                        className="w-5 h-5 text-[rgb(var(--star-warm-amber))]"
                        fill="currentColor"
                      />
                      {/* Micro-glow effect */}
        ...
        >
          {[
            ...
            { number: '50+', label: 'Business Clients', color: 'text-[rgb(var(--star-deep-sapphire))]' },
            { number: '4.9★', label: 'Average Rating', color: 'text-[rgb(var(--star-warm-amber))]' },
            { number: 'Years', label: 'Of Experience', color: 'text-[rgb(var(--star-deep-sapphire))]' },
          ].map((stat, index) => (
